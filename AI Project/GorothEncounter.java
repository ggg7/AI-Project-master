...
public class GorothEncounter implements Bosses
{
   int RBD;  
   int MD;   
   int RD;   
   ...
   public String gorothDisplay()
   {  
      System.out.println("Goroth damage "
      ...
      System.out.println("");
      return "The total damage dealt to Goroth was " + totalDamageDealt() + ".\nProceeding to second boss completed through this run.\n";
   }
}