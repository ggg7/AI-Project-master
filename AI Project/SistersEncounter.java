...
public class SistersEncounter implements Bosses
{
   int RBD;  
   int MD;   
   int RD;   
   ...
   public String sistersDisplay()
   {  
      System.out.println("Sisters of the Moon damage "
      ...
      System.out.println("");
      return "The total damage dealt to Priestess Lunaspyre, Huntress Kasparian, "
               + "\nCaptain Yathae Moonstrike and Moontalon was " + totalDamageDealt() + ".\nProceeding to sixth "
               + "boss completed through this run.\n";
   }
}