...
public class AvatarEncounter implements Bosses
{
   int RBD;  
   int MD;   
   int RD;   
      ...
      try{
         ...
         while((line = br.readLine()) != null)
         {
            ...
            if(line.contains("SPELL_DAMAGE,Player-157-067A545E,\"Larryg-DemonSoul\""))
            {
               ...
               {
                  if(line.contains("Fallen Avatar"))
                  {
   ...
   {  
      System.out.println("Fallen Avatar damage "
      ...
      System.out.println("");
      return "The total damage dealt to Fallen Avatar was " + totalDamageDealt() 
