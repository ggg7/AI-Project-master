...
public class DesolateHostEncounter implements Bosses
{
   int RBD;  
   int MD;   
   int RD;   
   ...
   {  
      System.out.println("The Desolate Host damage "
      ...
      System.out.println("");
      return "The total damage dealt to the Engine of Souls, Reanimated Templar, "
               + "\nand Ghastly Bonewarden was " + totalDamageDealt() + ".\nProceeding to seventh "
