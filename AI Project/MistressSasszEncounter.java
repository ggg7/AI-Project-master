...
public class MistressSasszEncounter implements Bosses
{
   int RBD;  
   int MD;   
   int RD;   
      ...
      try{
         ...
         while((line = br.readLine()) != null)
         {
            ...
            if(line.contains("SPELL_DAMAGE,Player-157-067A545E,\"Larryg-DemonSoul\""))
            {
               ...
               {
                  if(line.contains("Mistress Sassz"))
                  {
      ...
      try{
         ...
         while((line = br.readLine()) != null)
         {
            ...
            if(line.contains("SPELL_DAMAGE,Player-157-067A545E,\"Larryg-DemonSoul\""))
            {
               ...
               {
                  if(line.contains("Mistress Sassz") | line.contains("Abyss Stalker"))
                  {
   ...
   public String mistressDisplay()
   {  
      System.out.println("Mistress Sassz'ine damage "
      ...
      System.out.println("");
      return "The total damage dealt to Mistress Sassz'ine, the Abyss Stalker "
               + "\nand the Razorjaw Waverunner was " + totalDamageDealt() + ".\nProceeding to fourth boss completed through this run.\n";
   }
}