...
public class MaidenEncounter implements Bosses
{
   int RBD;  
   int MD;   
   int RD;   
   ...
   public String maidenDisplay()
   {  
      System.out.println("Maiden of Vigilance damage "
      ...
      System.out.println("");
      return "The total damage dealt to Maiden of Vigilance was " + totalDamageDealt() 
              + ".\nProceeding to eigth boss completed through this run.\n";
   }
}