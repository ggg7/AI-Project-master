...
public class KilJaedenEncounter implements Bosses
{
   int RBD;  
   int MD;   
   int RD;   
   ...
   {  
      System.out.println("Kil'Jaeden damage "
      ...
      System.out.println("");
      return "The total damage dealt to Kil'Jaeden, Shadowsoul, and Erupting Reflection was " + totalDamageDealt() 
              + ".\nProceeding to ninth and final boss completed through this run.\n";
   }
}